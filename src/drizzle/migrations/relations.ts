...
import { users, appraisalHeader, employees, calendarYears, contractExtensions, products, conversions, employeeQualifications, employeeUsers, employeeSession, employeeTerminations, employeeCertifications, departments, designations, employeesNoks, employeesOtherdetails, grnsHeader, ordersHeader, vendors, healthSafety, jobcardStaffs, jobcardTasks, employeesChildren, counties, employeesContacts, kpis, jobcardTimes, leaveApplications, leaveTypes, loanDeductions, staffLoans, materialIssuesHeader, jobcards, mrqHeaders, mrqDetails, projects, services, uoms, odometerReadings, motorVehicles, opportunitiesFiles, opportunities, notifications, saleAccounts, siteProjects, projectComments, vats, projectComponents, projectFinancials, quotationsHeader, quotationsItems, ordersDetails, productCategories, previousLostHours, salesSupportTickets, session, srnsHeader, salesOrdersHeader, staffObjectivesHeader, stockMovements, srnsDetails, staffObjectivesDetails, roles, appraisalDetails, grnsDetails, salesOrdersDetails, disciplinaryCases, disciplinaryCasesDocuments, disciplinaryCasesPersonnel, healthSafetyDocuments, userRoles, accounts } from "./schema";

export const appraisalHeaderRelations = relations(appraisalHeader, ({one, many}) => ({
	user: one(users, {
...
export const contractExtensionsRelations = relations(contractExtensions, ({one}) => ({
	user: one(users, {
...
export const employeesOtherdetailsRelations = relations(employeesOtherdetails, ({one}) => ({
	employee: one(employees, {
...
export const ordersHeaderRelations = relations(ordersHeader, ({one, many}) => ({
	grnsHeaders: many(grnsHeader),
	user: one(users, {
...
export const healthSafetyRelations = relations(healthSafety, ({one, many}) => ({
	department: one(departments, {
...
export const jobcardTasksRelations = relations(jobcardTasks, ({one, many}) => ({
	jobcardStaffs: many(jobcardStaffs),
...
export const employeesChildrenRelations = relations(employeesChildren, ({one}) => ({
	employee: one(employees, {
...
export const employeesContactsRelations = relations(employeesContacts, ({one}) => ({
	county: one(counties, {
...
export const materialIssuesHeaderRelations = relations(materialIssuesHeader, ({one}) => ({
	user: one(users, {
...
export const opportunitiesFilesRelations = relations(opportunitiesFiles, ({one}) => ({
	user: one(users, {
...
export const saleAccountsRelations = relations(saleAccounts, ({one, many}) => ({
	opportunities: many(opportunities),
	quotationsHeaders: many(quotationsHeader),
	user: one(users, {
...
export const quotationsHeaderRelations = relations(quotationsHeader, ({one, many}) => ({
	saleAccount: one(saleAccounts, {
...
export const quotationsItemsRelations = relations(quotationsItems, ({one}) => ({
...
export const previousLostHoursRelations = relations(previousLostHours, ({one}) => ({
	employee: one(employees, {
...
export const salesSupportTicketsRelations = relations(salesSupportTickets, ({one}) => ({
	saleAccount: one(saleAccounts, {
...
export const salesOrdersHeaderRelations = relations(salesOrdersHeader, ({one, many}) => ({
	saleAccount: one(saleAccounts, {
...
export const staffObjectivesHeaderRelations = relations(staffObjectivesHeader, ({one, many}) => ({
	user: one(users, {
...
export const staffObjectivesDetailsRelations = relations(staffObjectivesDetails, ({one}) => ({
...
export const appraisalDetailsRelations = relations(appraisalDetails, ({one}) => ({
...
export const salesOrdersDetailsRelations = relations(salesOrdersDetails, ({one}) => ({
...
export const disciplinaryCasesDocumentsRelations = relations(disciplinaryCasesDocuments, ({one}) => ({
...
export const disciplinaryCasesRelations = relations(disciplinaryCases, ({many}) => ({
	disciplinaryCasesDocuments: many(disciplinaryCasesDocuments),
	disciplinaryCasesPersonnels: many(disciplinaryCasesPersonnel),
}));

export const disciplinaryCasesPersonnelRelations = relations(disciplinaryCasesPersonnel, ({one}) => ({
	disciplinaryCase: one(disciplinaryCases, {
...
export const healthSafetyDocumentsRelations = relations(healthSafetyDocuments, ({one}) => ({
