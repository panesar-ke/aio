...
const route = getRouteApi('/_authed/procurement/purchase-order/new')
          ...
          <tbody>
            {details.map((f, index) => (
              <OrderDetailRow
                ...
                index={index}
                form={form}
                projects={routerData.selectableProjects}
                products={routerData.selectableProducts}
                services={routerData.selectableServices}
