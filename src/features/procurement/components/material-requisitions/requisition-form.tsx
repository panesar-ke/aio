...
import { useNextRequestId } from "../../hooks/use-next-request-id";
...
export function RequisitionForm({
  ...
  const { defaultDetails, getNextRequestId } = useNextRequestId(
    requisitionNo,
    requisition,
  );
                  ...
                  {field.state.value.map((f, i) => {
                    return (
                      ...
                      >
                        ...
                        >
                          <form.AppField name={`details[${i}].type`}>
                            {(field) => (
                        ...
                        >
                          ...
                          >
                            {(lineType) => {
                              const itemOptions = getLineItemOptions(lineType, {
                                products,
                                services,
                              });
                        ...
                        >
                          <form.AppField name={`details[${i}].projectId`}>
                            {(field) => (
                              <field.Combobox label="" items={projects ?? []} />
                            )}
                          </form.AppField>
                        </td>
                        <td
